        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "For each topic, include its name, description, and a short explanation of why it is relevant "
                    "(for example, based on semantic similarity and hierarchical context). "
